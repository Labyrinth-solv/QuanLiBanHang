...
//        btnDanhSachSanPham_DichVu.setDisable(true);
    ...
    private void addEvents() {
        ...
        btnDanhSachSanPham_QuanLyKho.setOnMouseEntered(this::mouseEnter);

        btnDanhSachSanPham_QuanLyKho.setOnMouseExited(this::mouseExit);
        ...
        btnDatHang_QuanLyKho.setOnMouseEntered(this::mouseEnter);

        btnDatHang_QuanLyKho.setOnMouseExited(this::mouseExit);
        ...
        btnNhapHang_QuanLyKho.setOnMouseEntered(this::mouseEnter);

        btnNhapHang_QuanLyKho.setOnMouseExited(this::mouseExit);
        ...
        btnBaoCaoNhapXuatHang.setOnMouseEntered(this::mouseEnter);

        btnBaoCaoNhapXuatHang.setOnMouseExited(this::mouseExit);
        ...
        btnDSNhaCungCap.setOnMouseEntered(this::mouseEnter);

        btnDSNhaCungCap.setOnMouseExited(this::mouseExit);
    ...
    private void hienThiDSNhaCungCap() throws IOException {
        if(flagForDSNhaCungCap == -1) {
            ...
            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/View/DSNhaCungCap.fxml")));
    ...
    private void hienThiBaoCaoNhapXuat() throws IOException {
        if(flagForNhapXuatHang == -1) {
            ...
            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/View/BaoCaoNhapHang.fxml")));
            tab1.setContent(root);
            tab.getTabs().add(tab1);
    ...
    private void hienThiNhapHang() throws IOException {
        if(flagForNhapHang == -1) {
            ...
            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/View/NhapHang.fxml")));
            tab1.setContent(root);
            tab.getTabs().add(tab1);
    ...
    private void hienThiDatHang() throws IOException {
        if(flagForDatHang == -1) {
            ...
            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/View/DatSanPham.fxml")));
            tab1.setContent(root);
            tab.getTabs().add(tab1);
    ...
    private void hienThiDSSP_Kho() throws IOException {
        if(flagForDSSP_Kho == -1) {
            ...
            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/View/DSSP_Kho.fxml")));
            tab1.setContent(root);
            tab.getTabs().add(tab1);
